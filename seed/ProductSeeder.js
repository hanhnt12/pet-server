...
function getCategories() {
  ...
  Category.find({}, function (err, docs) {
    ...
    var products = [
      new Product({
        imagePath: 'http://www.whitewaypetshop.net/img/0573/125.jpg',
      ...
      new Product({
        imagePath: 'http://www.whitewaypetshop.net/img/0573/331.jpg',
        title: 'Our Pets',
      ...
      new Product({
        imagePath: 'http://www.whitewaypetshop.net/img/0573/587.jpg',
      ...
      new Product({
        imagePath: 'http://www.whitewaypetshop.net/img/0573/551.jpg',
      ...
      new Product({
        imagePath: 'http://www.whitewaypetshop.net/img/0579/448.jpg',
      ...
      new Product({
        imagePath: 'http://cdn.skim.gs/image/upload/v1456338394/msi/designer-pet-accessories-coach-collar_ytgkd1.jpg',
      ...
      new Product({
        imagePath: 'http://cdn.skim.gs/image/upload/c_fill,dpr_1.0,f_auto,fl_lossy,q_auto,w_940/v1456338396/msi/designer-pet-accessories-coach-leash_yqv2rk.jpg',
      ...
      new Product({
        imagePath: 'http://www.illtakecareofitconcierge.com/wp-content/uploads/pet-stuff-services-300x225.jpg',
        title: 'Pet Stuff',
      ...
      new Product({
        imagePath: 'http://pad3.whstatic.com/images/thumb/1/1b/Take-Care-of-Puppies-Step-28.jpg/aid165555-v4-728px-Take-Care-of-Puppies-Step-28.jpg',
